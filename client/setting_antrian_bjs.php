...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "DELETE FROM antrian_bojongsari WHERE tanggal = :tanggal";
...
// Ambil data dari tabel log_antrian_bojongsari
$search = isset($_GET['search']) ? $_GET['search'] : '';
$sql = "SELECT * FROM log_antrian_bojongsari";
if (!empty($search)) {
...
if (isset($_GET['delete_id'])) {
    ...
    $delete_sql = "DELETE FROM log_antrian_bojongsari WHERE id = :id";
...
if (isset($_POST['edit_id'])) {
    ...
    $update_sql = "UPDATE log_antrian_bojongsari SET nama = :nama, telepon = :telepon WHERE id = :id";
